...
abstract class WithJsBrowser[WEBDRIVER <: WebDriver](app: FakeApplication = FakeApplication()) extends WithBrowsers(WebDriverHelper.createDefaultWebDriver(true), app)

abstract class WithBrowser[WEBDRIVER <: WebDriver](app: FakeApplication = FakeApplication()) extends WithBrowsers(WebDriverHelper.createDefaultWebDriver(false), app)
